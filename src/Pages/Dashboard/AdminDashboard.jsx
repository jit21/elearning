            ...
            <div className="min-h-[90vh] pt-5 flex flex-col flex-wrap gap-10 text-white">
                ...
                <div className="mx-[10%] w-[80%] self-center flex flex-col items-center justify-center gap-10 mb-10">
                    ...
                    <table className="table overflow-x-scroll">
                            <thead>
                                <tr>
                                    <th className="text-green-600">S No</th>
                                    <th className="text-green-600">Course Title</th>
                                    <th className="text-green-600">Course Category</th>
                                    <th className="text-green-600">Instructor</th>
                                    <th className="text-green-600">Total Lectures</th>
                                    <th className="text-green-600">Description</th>
